...
F 2 "CustomFootprints:PinSocket_2x03_P2.54mm_Vertical(Flipped)" H 8750 1050 50  0001 C CNN
...
U 1 1 61A67799
P 10325 6300
F 0 "#PWR0109" H 10325 6050 50  0001 C CNN
F 1 "GND" H 10330 6127 50  0000 C CNN
F 2 "" H 10325 6300 50  0001 C CNN
F 3 "" H 10325 6300 50  0001 C CNN
	1    10325 6300
	1    0    0    -1  
$EndComp
Text Label 9425 5100 0    50   ~ 0
ESP-RST
$Comp
L Device:R_Small RN5A1
U 1 1 61C3FCE1
P 9375 4950
F 0 "RN5A1" V 9575 4950 50  0000 C CNN
F 1 "10K" V 9475 4950 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad0.98x0.95mm_HandSolder" H 9375 4950 50  0001 C CNN
...
U 1 1 61C3FCEB
P 9375 4850
F 0 "#PWR0115" H 9375 4700 50  0001 C CNN
F 1 "+3V3" H 9390 5023 50  0000 C CNN
...
U 1 1 61C3FCF9
P 8925 5100
F 0 "RST-DTSM6" H 8925 5400 50  0000 C CNN
F 1 "ESP-PRG" H 8925 5294 50  0000 C CNN
F 2 "Button_Switch_THT:SW_PUSH_6mm" H 8925 5300 50  0001 C CNN
...
U 1 1 61D2C8EE
P 8725 5100
F 0 "#PWR0116" H 8725 4850 50  0001 C CNN
F 1 "GND" H 8730 4927 50  0000 C CNN
F 2 "" H 8725 5100 50  0001 C CNN
...
Wire Wire Line
	4400 5875 4500 5875
$Sheet
S 7100 4625 600  1125
U 620ECEE2
F0 "TeensyAudioShield" 50
F1 "TeensyAudioShield.sch" 50
F2 "LINEOUT_R" O L 7100 4800 50 
F3 "LINEOUT_L" O L 7100 4700 50 
F4 "CTRL_DATA" I R 7700 4925 50 
F5 "CTRL_CLK" I R 7700 5025 50 
F6 "SYS_MCLK" I R 7700 5125 50 
F7 "I2S_SCLK" I R 7700 5225 50 
F8 "I2S_LRCLK" I R 7700 5325 50 
F9 "I2S_DIN" I R 7700 5425 50 
F10 "I2S_DOUT" O R 7700 5525 50 
F11 "CTRL_ADR0_CS" I R 7700 5625 50 
$EndSheet
NoConn ~ 3825 2800
NoConn ~ 4775 4850
...
F0 "AmpV2" 50
F1 "AmpV2.sch" 50
F2 "LINEIN_L" I L 7125 6200 50 
F3 "LINEIN_R" I L 7125 6300 50 
F4 "VIN" I R 7800 6250 50 
$EndSheet
Wire Wire Line
	2400 6800 2325 6800
Wire Wire Line
...
U 1 1 61C435F7
P 10325 5300
F 0 "MOD1" H 10225 5903 60  0000 C CNN
F 1 "2491" H 10225 5797 60  0000 C CNN
F 2 "digikey-footprints:WIFI_Module_ESP8266_2491" H 10525 5500 60  0001 L CNN
F 3 "https://media.digikey.com/pdf/Data%20Sheets/Adafruit%20PDFs/2491_Web.pdf" H 10525 5600 60  0001 L CNN
F 4 "1528-1438-ND" H 10525 5700 60  0001 L CNN "Digi-Key_PN"
F 5 "2491" H 10525 5800 60  0001 L CNN "MPN"
F 6 "RF/IF and RFID" H 10525 5900 60  0001 L CNN "Category"
F 7 "RF Transceiver Modules" H 10525 6000 60  0001 L CNN "Family"
F 8 "https://media.digikey.com/pdf/Data%20Sheets/Adafruit%20PDFs/2491_Web.pdf" H 10525 6100 60  0001 L CNN "DK_Datasheet_Link"
F 9 "/product-detail/en/adafruit-industries-llc/2491/1528-1438-ND/5761206" H 10525 6200 60  0001 L CNN "DK_Detail_Page"
F 10 "ESP8266 SMT MODULE" H 10525 6300 60  0001 L CNN "Description"
F 11 "Adafruit Industries LLC" H 10525 6400 60  0001 L CNN "Manufacturer"
F 12 "Active" H 10525 6500 60  0001 L CNN "Status"
	1    10325 5300
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61C6DAE9
P 10725 4850
F 0 "C7" V 10975 4800 50  0000 L CNN
F 1 "22uf" V 10875 4750 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 10725 4850 50  0001 C CNN
...
U 1 1 61C6DAEF
P 10725 5000
F 0 "#PWR0110" H 10725 4750 50  0001 C CNN
F 1 "GND" H 10730 4827 50  0000 C CNN
...
U 1 1 61C6DAF5
P 10725 4700
F 0 "#PWR0111" H 10725 4550 50  0001 C CNN
F 1 "+3V3" H 10740 4873 50  0000 C CNN
F 2 "" H 10725 4700 50  0001 C CNN
F 3 "" H 10725 4700 50  0001 C CNN
	1    10725 4700
	1    0    0    -1  
$EndComp
Connection ~ 10725 4700
Wire Wire Line
	10325 4700 10725 4700
Wire Wire Line
	10625 5300 11175 5300
Text Label 10875 5300 0    50   ~ 0
ESP-RX
Wire Wire Line
	10625 5400 11175 5400
Text Label 10875 5400 0    50   ~ 0
ESP-TX
NoConn ~ 9825 5600
NoConn ~ 9825 5700
NoConn ~ 10625 5700
...
ESP-EN
Wire Wire Line
	10325 6300 10325 6200
Text Label 9775 5400 2    50   ~ 0
ESP-GPIO2
$Comp
L Device:R_Small RN5B1
U 1 1 61F0AB32
P 9175 5400
F 0 "RN5B1" V 8979 5400 50  0000 C CNN
F 1 "10K" V 9070 5400 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad0.98x0.95mm_HandSolder" H 9175 5400 50  0001 C CNN
...
U 1 1 61F0AB39
P 8975 5350
F 0 "#PWR0112" H 8975 5200 50  0001 C CNN
F 1 "+3V3" H 8990 5523 50  0000 C CNN
...
U 1 1 6202A396
P 8575 6025
F 0 "#PWR0113" H 8575 5775 50  0001 C CNN
F 1 "GND" H 8580 5852 50  0000 C CNN
...
U 1 1 6202A39D
P 9225 5775
F 0 "R2" V 9325 5775 50  0000 C CNN
F 1 "10K" V 9425 5775 50  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad0.98x0.95mm_HandSolder" H 9225 5775 50  0001 C CNN
F 3 "~" H 9225 5775 50  0001 C CNN
	1    9225 5775
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 6202A3A3
P 9225 5675
F 0 "#PWR0114" H 9225 5525 50  0001 C CNN
F 1 "+3V3" H 9240 5848 50  0000 C CNN
...
$EndComp
$Comp
L Switch:SW_Push_Dual_x2 PRG-DTSM1
U 1 1 6202A3A9
P 8775 5925
F 0 "PRG-DTSM1" H 8775 6175 50  0000 C CNN
F 1 "ESP-PRG" H 8775 6075 50  0000 C CNN
F 2 "Button_Switch_THT:SW_PUSH_6mm" H 8775 6125 50  0001 C CNN
...
D20-A6-TX5-LRCLK1
Text Label 7725 5425 0    50   ~ 0
D7-RX2-OUT1A
Text Label 7725 5525 0    50   ~ 0
D8-TX2-IN1
Text Label 7725 5625 0    50   ~ 0
D15-A1-RX3-SPDIF_IN
Wire Notes Line
	8475 6525 8475 4450
Wire Wire Line
...
Wire Wire Line
	7025 6200 7125 6200
Text Notes 9450 4625 0    118  ~ 0
ESP8266
Text Label 7925 6250 0    50   ~ 0
VIN
Wire Wire Line
	7800 6250 8050 6250
$EndSCHEMATC
